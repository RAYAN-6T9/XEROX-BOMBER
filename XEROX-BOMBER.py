...
\033[1;96m╚═╝░░╚═╝╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚══╝   \033[1;92m
\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE :\033[1;32m SMS BOMBING
\033[1;32m[-] AUTHOR     :\033[1;32m RAYAN MAHMUD RAHAT
\033[1;32m[-] GITHUB     :\033[1;32m X3ROX-143
\033[1;32m[-] STATUS     :\033[1;32m FREE
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME RAYAN IS BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
...
rp= 'RAYAN'
x = '6T9'
if 'RAYAN'==user and '6T9'==pas:
	Axak(g+"\n\nLOGIN SUCCESSFUL FOLLOW MY GITHUB ")
	os.system('xdg-open https://www.github.com/RAYAN-6T9')
else:
	Axak(y+"\n\nINVALID USER OR PASS")
	Axak(y+"\n\nCONTACT ADMIN FOR USER & PASS")
	os.system("xdg-open https://wa.me/+8801892901813")
	
	os.system("python XEROX-BOMBER.py")
...
print (logo)
print(w+"[~] PLEASE WAIT INTERNET CONNECTION CHECKING...  ")
os.system('clear')
print(logo)
print(w+"[~] CONNECTING TO THE INTERNET")
print(f"\n{r}Note : {w}1 SMS UP TO SENT 18 SMS !!")
try:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH RAYAN-6T9 ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://facebook.com/100090423955128")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	...
	print(f"\n {ran2}SMS SENT SUCCESFULLY BY RAYAN-6T9 "+w+tim)
    ...
    input(g+"\nSMS BOMBING COMPLETE ENTER TO CONTINUE")
os.system("clear")
os.system("python XEROX-BOMBER.py")